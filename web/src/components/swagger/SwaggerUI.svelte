...
<script lang="ts">
	...
	export let swagger: any;
	export let url: string;
	let baseurl = '';
	let active: Record<string, any> = {};
	let responses: Record<string, any> = {};
	let requestParams: Record<string, any> = {};
	let requestBodyExample: Record<string, any> = {};
	...
	const getSchema = (refName) => {
		...
		return swagger[division[0]][division[1]][division[2]] as Record<string, any>;
	};
...
<main>
	<div class="rf-container">
		{#if swagger}
			...
			<h3 class=""><a href={url}>Download swagger file</a></h3>
				...
				<div class="box">
					...
					{#each category[1] as method, methodIdx}
						<div class="box">
							<div
								class="rf-grid-row"
								on:click={() => (active[method['id']] = !active[method['id']])}
							>
							...
							<div class="swagger-method-details open" class:open={active[method['id']]}>
											...
											<div class="table-container">
												...
												{#if '$ref' in requestBody[1]['schema']}
													<div class="rf-input-group">
														...
														<textarea
															class="rf-input"
															id="textarea-{method['id']}"
															name="textarea"
															placeholder="Fixed size textarea"
															bind:value={requestBodyExample[method['id']]}
														/>
													</div>
												{/if}
											</div>
														...
														<tr>
															...
															<td>
																<input
																	...
																	bind:value={requestParams[`${method['id']}-${parameter.name}`]}
																/>
															</td>
								...
								<button
									class="rf-btn"
									on:click={() =>
										handleRequest(method.route, method.method, method.id, method.parameters)}
								>
									Execute
								</button>
								{#if responses[method['id']]}
									<p>Url: {responses[method['id']].url}</p>
									<h4>Result</h4>
									<div class="rf-callout">
										<div class="rf-grid-row">
											<div class="rf-col-xs-12 rf-col-lg-2">
												{responses[method['id']].status}
												<p>{responses[method['id']].statusText}</p>
											</div>
											<div class="rf-col-xs-12 rf-col-lg-10">
												<p>Headers:</p>
												<pre><code>
                        {[...responses[method['id']].headers.entries()]
															.map((x) => x.join(': '))
															.join(' \n')}
                          </code></pre>
														...
														<div class="rf-col-xs-12 rf-col-lg-10">
															...
															{#if '$ref' in content[1].schema}
																<ul>
																	...
																	<pre><code>
                                {JSON.stringify(
																				getSchema(content[1].schema['$ref']).example,
																				null,
																				2
																			)}
                                    </code></pre>
...
<style lang="scss">
	...
	// Swagger
	$swagger-base-font-size: 16px;
	$swagger-spacing-unit: 30px;
	...
	.rf-background--get {
		background-color: var(--gm500) !important;
	}

	.rf-background--delete {
	...
	*,
	...
	.rf-fi-alert-line:before {
		content: '\f105';
	}
	.rf-fi-arrow-down-line:before {
		content: '\f106';
	}
	.rf-fi-arrow-down-s-line:before,
	.rf-nav__item > .rf-btn::before {
		content: '\f107';
	}
	.rf-fi-arrow-left-line:before,
	.rf-link.rf-link--icon-left:not([class*='rf-fi-'])::before {
		content: '\f108';
	}
	.rf-fi-arrow-left-s-first-line:before,
	...
	.rf-fi-arrow-left-s-line:before,
	.rf-pagination__item--prev::before {
		content: '\f10b';
	}
	.rf-card:not(.rf-card--no-arrow) .rf-card__body::after,
	.rf-fi-arrow-right-line:before,
	.rf-link:not([class*='rf-fi-'])::before {
		content: '\f10c';
	}
	.rf-fi-arrow-right-s-last-line:before,
	...
	.rf-fi-arrow-right-s-line:before,
	...
	.rf-fi-external-link-line:before,
	...
	@media all and (-ms-high-contrast: none) and (min-width: 48em),
		(-ms-high-contrast: active) and (min-width: 48em) {
		.rf-nav--align-right {
	...
	.rf-btn--sm.rf-btn--icon-left::before,
	.rf-btn--sm.rf-btn--icon-right::before,
	...
	.rf-radio-group input[type='radio']:disabled:hover + label,
	.rf-radio-group input[type='radio'][disabled]:hover + label,
	...
	.rf-header__popin::after,
	.rf-header__popin::before {
		content: '';
		display: block;
		width: 100%;
		height: 4.5rem;
	...
	.rf-shortcuts__item[class*=' rf-fi-']::before,
	.rf-shortcuts__item[class^='rf-fi-']::before {
		font-family: icons !important;
		font-style: normal;
		font-weight: 400 !important;
	...
	.rf-input-wrap[class*=' rf-fi-']::before,
	.rf-input-wrap[class^='rf-fi-']::before {
		font-family: icons !important;
		font-style: normal;
		font-weight: 400 !important;
	...
	.rf-nav__item > .rf-btn::after,
	.rf-nav__item > .rf-link::after {
		content: '';
		position: absolute;
		top: 0;
		bottom: 0;
	...
	.rf-nav__item > .rf-btn:hover::after,
	.rf-nav__item > .rf-link:hover::after {
		background-color: rgba(
			var(--hover-shade),
			var(--hover-shade),
			var(--hover-shade),
	...
	.rf-nav__item > .rf-btn:active::after,
	.rf-nav__item > .rf-link:active::after {
		background-color: rgba(
			var(--hover-shade),
			var(--hover-shade),
			var(--hover-shade),
	...
	.rf-pagination__item:not(.rf-pagination__item--first):not(.rf-pagination__item--prev)::before,
	.rf-pagination__item:not(.rf-pagination__item--next):not(.rf-pagination__item--last)::after {
		content: none;
		margin: 0;
		display: none;
	}
	...
	.rf-pagination__item--next,
	.rf-pagination__item--prev + .rf-pagination__item,
	.rf-pagination__item:not(.rf-pagination__item--next) + .rf-pagination__item--last {
		margin-left: 0.75rem;
	}
	.rf-pagination__item--first,
	.rf-pagination__item--last,
	.rf-pagination__item--next,
	...
	.rf-select:-webkit-autofill,
	.rf-select:-webkit-autofill:focus,
	.rf-select:-webkit-autofill:hover {
		box-shadow: inset 0 0 0 100px var(--g200);
		-webkit-text-fill-color: var(--g800);
	}
	.rf-tile {
